...
int main(void)
{
	...
	ft_printf("-------------------------\n");
    ft_printf("FT_PRINTF: The value of (INT_MAX + 1) is: nb5 = %d\n", nb5 + 1);
       printf("---PRINTF: The value of (INT_MAX + 1) is: nb5 = %d\n", nb5 + 1);
	ft_printf("FT_PRINTF: The value of (INT_MIN - 1) is: nb6 = %d\n", nb6 - 1);
       printf("---PRINTF: The value of (INT_MIN - 1) is: nb6 = %d\n", nb6 - 1);
